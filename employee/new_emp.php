            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="pull-right"><a href="logout.php"><i class="fa fa-fw fa-sign-out fa-lg"></i>
                                LogOut</a></li>
                        <li class="pull-right"><a href="#bot"><i class="fa fa-fw fa-envelope fa-lg"></i> Contact</a>
                        </li>
                        <!-- #END# Tasks -->
                    </ul>
                </div>
                ...
                <form id="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Father Name
                                </p>
                                <input type="text" class="form-control" name="fname" placeholder="Enter father name"
                                    required>
                            </div>
                            <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">DateOfBirth
                                </p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Mobile
                                    Number</p>
                                <input type="number" class="form-control" name="contect"
                                    placeholder="Enter contect number" required>
                            </div>
                            <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Email
                                    Account</p>
                                <input type="email" class="form-control" name="email" placeholder="Enter email account"
                                    required>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Marital
                                    Status</p>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <input type="file" name="userImage" onChange="displayImage(this)" id="profileImage"
                                    style="margin-bottom: -10px; " class="custom-file-input" required>
                            </div>
                        </div>
                        <hr
                            style="height:1px;border-width:0; width: 100%; margin-bottom:-5px; color:red;background-color:gray;">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Postal Code
                                </p>
                                <input type="number" class="form-control" name="postal" placeholder="Enter postal code"
                                    required>
                            </div>
                            <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Home Address
                                </p>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Education
                                    Level</p>
                                <input type="text" class="form-control" name="edu" placeholder="Enter your education"
                                    required>
                            </div>
                            <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Current Job
                                    Title</p>
                                <input type="text" class="form-control" id="title" name="title"
                                    placeholder="Enter current job title" required>
                            </div>
                            <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Experience
                                </p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">User Type
                                </p>
                            ...
                            <div class="col-sm-12">
                                <center>
                                    <button type="submit"
                                        ...
                                        class="btn btn-primary" name="insert">Register</button>
                                </center>
                            </div>
                        </div>
                    </div>
                ...
                <div class="footer-basic" id="bot">
                    <footer>
                        ...
                        <div class="social"><a href="https://www.instagram.com/amirghafoor786/"><i
                                    ...
                                    class="icon ion-social-skype"></i></a><a
                                href="https://twitter.com/AmirGha59143587"><i class="icon ion-social-twitter"></i></a><a
