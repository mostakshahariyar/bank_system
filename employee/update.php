                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <input type="file" name="userImage" onChange="displayImage(this)" id="profileImage"
                            style="margin-bottom: -10px; " class="custom-file-input">
                    </div>
                </div>
                <center>
                </center>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="number" class="form-control" name="contect"
                                value="<?php echo $row['contect']; ?>" required>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" name="address"
                                value="<?php echo $row['houseaddress']; ?>" required>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" name="title"
                                value="<?php echo $row['account_title']; ?>" required>
                        </div>
                        <div class="col-lg-4">
                        ...
                        <div class="col-sm-12">
                            <center>
                                <button type="submit"
                                    ...
                                    class="btn btn-primary" name="insert">Update Account</button>
                            </center>
                        </div>
                    </div>
                </div>
