...
if (isset($_POST['transfer'])) {
    ...
    if ($rs1) {
        ...
        if ($connected) {
            $msg = "Hello dear " . $name . "! You have deposit balance in your SKY BANK account  on " . $tms1 . ". Amount " . $newbnc . ".00BD deposit successfully. Your current account balance is " . $bnc1 . ".00BD. Thank you for joining SKY BANK service.";
        ...
        <div class="container-fluid">
            ...
            <div class="box-body">
                <form id="form" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="sender" placeholder="Enter account number"
                                id="snd" required>
                        </div>
                        <div class="col-sm-4">
                    ...
                    if (mysqli_num_rows($nm) > 0) {
                        ...
                        <form id="form2" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <p for="exampleInputEmail1" style="margin-bottom: 1px; margin-top: 8px;">Account Holder Name
                                    </p>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    ...
                                    <input type="number" class="form-control" name="amount" id="am" min="500"
