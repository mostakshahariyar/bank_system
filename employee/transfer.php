                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <input type="text" class="form-control" name="sender"
                                placeholder="Enter sender account number" id="snd" required>
                        </div>
                        <div class="col-sm-5">
                            <p for="exampleInputEmail1" style="margin-bottom: 1px; margin-top: 8px;">Reciever Account
                            </p>
                            <input type="text" class="form-control" name="reciever"
                                placeholder="Enter reciever account number" id="rcn" required>
                        </div>
                        <div class="col-sm-2">
                            <input type="submit" class="btn btn-primary form-control"
                                style="margin-top: 28px; font-size: 17px; width: 120px; border-radius: 5px;"
                                name="filter" id="sbtn" value="Search">
                        </div>
                    </div>
                </form>
                <hr
                                ...
                                <form id="form2" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <p for="exampleInputEmail1" style="margin-bottom: 1px; margin-top: 8px;">Reciever Account
                                                Title</p>
                                            <input type="text" class="form-control" name="reciever1"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <p for="exampleInputEmail1" style="margin-bottom: 1px; margin-top: 8px;">Transection Amount
                                            </p>
                                            <input type="number" class="form-control" name="amount" id="am" min="2000"
                                                placeholder="Enter transection amount" required>
                                        </div>
                                        <div class="col-sm-2">
                                            <input type="submit" class="btn btn-primary form-control"
                                                style="margin-top: 28px; font-size: 17px; width: 120px; border-radius: 5px;"
