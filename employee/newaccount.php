            ...
            <div class="container-fluid">
                ...
                <form id="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Account
                                    Title</p>
                                <input type="text" class="form-control" name="title" placeholder="Enter account title"
                                    required>
                            </div>
                            <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Account
                                    Balance</p>
                                <input type="number" class="form-control" id="blnc" name="balance" min="2000"
                                    placeholder="Enter minimum 2000 account balance" required>
                            </div>
                            <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Account Type
                                </p>
