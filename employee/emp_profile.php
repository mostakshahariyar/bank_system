        ...
        <div class="container-fluid">
            ...
            <form id="form" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Education Level
                            </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Registered Date
                            </p>
