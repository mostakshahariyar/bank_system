    ...
    <div class="container-fluid">
      ...
      if ($_GET['id'] == "") {
        ...
        <form id="form" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-sm-8">
              <input type="text" class="form-control" name="sender" placeholder="Enter account number for history"
                id="snd" required>
            </div>
            <div class="col-sm-2">
              <input type="submit" class="btn btn-primary form-control"
                style=" font-size: 17px; width: 120px; border-radius: 5px;" name="filter" id="sbtn" value="Search">
            </div>
          </div>
        </form>
        <hr
              ...
              <table class="table" id="myTable">
                ...
                <tbody id="body">
                  ...
                  if (mysqli_num_rows($nm) > 0) {
                    ...
                    ?>
                    <tr>
                      <td style="text-align: center;padding-top: 25px; font-size: 20px;" colspan="7">No account history found
                      </td>
                    </tr>
                    <?php
                  } ?>
