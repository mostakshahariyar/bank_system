                ...
                <div class="row">
                    <div class="col-sm-4">
                        <input type="text" id="myInput" class="cs form-control" onkeyup="myFunction()"
                            placeholder="Search with name or account number" title="Type in a name">
                    </div>
                    <form method="post" id="form_id">
                        <div class="col-sm-3">
                            <input type="date" name="date_start" class="form-control" placeholder="Enter start date"
                                required>
                            <input type="hidden" name="sd" class="form-control" value="<?php echo $sender ?>">
                        </div>
                        <div class="col-sm-3">
                            <input type="date" name="date_end" class="form-control" placeholder="Enter end date"
                                required>
                        </div>
                        <div class="col-sm-2">
                            <input type="submit" class="btn btn-primary"
                                style="font-size: 17px; width: 120px; height: 32px; border-radius: 5px;" name="dt"
                                value="Filter">
                        </div>
                    </form>
                </div>
