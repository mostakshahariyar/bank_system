        ...
        <div class="container-fluid">
            <div class="block-header">
                <p style="margin-left: -15px; font-size: 17px; font-weight: bold;">
                    <?php echo $_GET["id"] . " Accounts List" ?>
                </p>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <input type="text" id="myInput" class="cs form-control" onkeyup="myFunction()"
                            placeholder="Search with name, cnic, title, account" title="Type in a name">
                    </div>
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        <tr style="height: 50px;">
                                            <td style="text-align: center; padding: 2px 2px 2px 2px;">
                                                <?php echo '<img src="data:image/jpeg;base64,' . base64_encode($row['img']) . '" style="width:60px; height:60px;"/>' ?>
                                            </td>
