        ...
        <div class="row">
          <div class="col-sm-4">
            <input type="text" id="myInput" class="cs form-control" onkeyup="myFunction()"
              placeholder="Search from table with id, name and cnic" title="Type in a name">
          </div>
          <?php
          ...
          <form method="post" id="form_id">
            ...
            <div class="col-sm-2">
              <input type="submit" class="btn btn-primary"
                style="font-size: 17px; width: 120px; height: 32px; border-radius: 5px;" name="filter" value="Filter">
            </div>
          </form>
        </div>
      </div>
                    ...
                    if ($_SESSION['id'] != $row['id']) {
                      ...
                      <tr style="height: 50px;">
                        <td style="text-align: center; padding: 2px 2px 2px 2px;">
                          <?php echo '<img src="data:image/jpeg;base64,' . base64_encode($row['image']) . '" style="width:60px; height:60px;"/>' ?>
                        </td>
                        ...
                        <td style="text-align: center;padding-top: 15px;">
                          <div class="action_btn"><a href="emp_profile.php?id=<?php echo $row['id']; ?>"
                              class="click_ripple_shine success" title="View"><i class="icon fa fa-eye"></i> </a>
                            <?php
                            if ($row['status'] == "Active") {
                              ?>
                              <a href="emp_block.php?id=<?php echo $row['id']; ?>& type=Block" class="dng1"
                                title="Block Account"><i class="icon fa fa-ban"></i></a>
                            <?php } ?>
                            <?php
                            if ($row['status'] == "Block") {
                              ?>
                              <a href="emp_block.php?id=<?php echo $row['id']; ?>& type=Active" class="success dng"
                                title="Activate Account"><i class="icon fa fa-check"></i></a>
                            <?php } ?>
                            <a href="emp_update.php?id=<?php echo $row['id']; ?>" class="click_ripple_shine warning"
                              title="Edit"><i class="icon fa fa-pencil-square-o"></i></a>
                            <a href="emp_delete.php?id=<?php echo $row['id']; ?>" class="danger" title="Delete"><i
      ...
      <div class="footer-basic" id="bot">
        <footer>
          ...
          <div class="social"><a href="https://www.instagram.com/amirghafoor786/"><i
                class="icon ion-social-instagram"></i></a><a href="#"><i class="icon ion-social-skype"></i></a><a
              href="https://twitter.com/AmirGha59143587"><i class="icon ion-social-twitter"></i></a><a
              href="https://web.facebook.com/amirghafoor.chaudhry/"><i class="icon ion-social-facebook"></i></a></div>
