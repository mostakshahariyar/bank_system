                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li><a href="employee/change_pin.php"><i class="material-icons">lock</i>Change Password</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-pink hover-expand-effect">
                            ...
                            <div class="content">
                                ...
                                <div>
                                    <h4 style="margin-top: 5px; font-size: 20px;">
                                        <?php echo r_format("SELECT count(account_type) as total FROM accounts_info where account_type='Current'") ?>
                                    </h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-light-green hover-expand-effect">
                            ...
                            <div class="content">
                                ...
                                <div>
                                    <h4 style="margin-top: 5px; font-size: 20px;">
                                        <?php echo r_format("SELECT count(account_type) as total FROM accounts_info where account_type='Saving'") ?>
                                    </h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-orange hover-expand-effect">
                            ...
                            <div class="content">
                                ...
                                <div>
                                    <h4 style="margin-top: 5px; font-size: 20px;">
                                        <?php echo rup_format("SELECT SUM(balance) as total FROM accounts_info") ?>
                                    </h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-purple hover-expand-effect">
                            ...
                            <div class="content">
                                ...
                                <div>
                                    <h4 style="margin-top: 5px; font-size: 20px;">
                                        <?php echo rup_format("SELECT SUM(amount) as total FROM account_history where type='Withdraw'") ?>
                                    </h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-cyan hover-expand-effect">
                            ...
                            <div class="content">
                                ...
                                <div>
                                    <h4 style="margin-top: 5px; font-size: 20px;">
                                        <?php echo rup_format("SELECT SUM(amount) as total FROM account_history where type='Deposit'") ?>
                                    </h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-green hover-expand-effect">
                            ...
                            <div class="content" id="bnk">
                                ...
                                <div>
                                    <h4 style="margin-top: 5px; font-size: 20px;">
                                        <?php echo rup_format("SELECT SUM(amount) as total FROM account_history where type='Transection'") ?>
                                    </h4>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="info-box bg-brown hover-expand-effect">
                                    ...
                                    <div class="content">
                                        ...
                                        <div>
                                            <h4 style="margin-top: 5px; font-size: 20px;">
                                            <?php echo r_format("SELECT count(role) as total FROM users WHERE role='Admin'") ?>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box bg-blue hover-expand-effect">
                                ...
                                <div class="content">
                                    ...
                                    <div>
                                        <h4 style="margin-top: 5px; font-size: 20px;">
                                        <?php echo r_format("SELECT count(role) as total FROM users WHERE role='Employee'") ?>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-striped" id="myTable">
                                        ...
                                        <tbody>
                                            ...
                                            if (mysqli_num_rows($num) > 0) {
                                                ...
                                                ?>
                                                <tr>
                                                    <td style="text-align: center;padding-top: 25px; font-size: 20px;"
                                                        colspan="7">No any history found</td>
                                                </tr>
                                                <?php
                                            }
                                            ?>
                            ...
                            <div class="header">
                                ...
                                <ul class="header-dropdown m-r--5">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li><a href="employee/history_details.php?ty=Transection">Transection
                                                    history</a></li>
                                            <li><a href="employee/history_details.php?ty=Recieved">Recieved history</a>
                                            </li>
                                            <li><a href="employee/history_details.php?ty=Withdraw">Withdrawal
                                                    history</a></li>
                                            <li><a href="employee/history_details.php?ty=Deposit">Deposit history</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
